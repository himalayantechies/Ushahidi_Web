						...
						<div class="entry">
							...
							<div class="entryBody">
								...
								<div class="actionable">
									<span class="label"> Actionable: </span><xsl:value-of select="actionable"/>
									<span class="label"> Urgent: </span><xsl:value-of select="action_urgent"/>
									<span class="label"> Action Taken: </span><xsl:value-of select="action_taken"/>
									<span class="label"> Closed: </span><xsl:value-of select="action_closed"/>
									<xsl:if test="string-length(action_summary) != 0">
										<span class="label">Action Summary: </span>
										<xsl:value-of select="action_summary"/>
									</xsl:if>
								</div>
								...
								<xsl:if test="string-length(comment) != 0">
									<div>
										<span class="label">Comment Date: </span><xsl:value-of select="comment_date"/>
									</div>
									<div>
										<span class="label">Comment: </span><xsl:value-of select="comment"/>
									</div>
								</xsl:if>
